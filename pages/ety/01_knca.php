    ...
    <div class="divide50">
        <div class="row about01">
                        <div class="col-md-3 text-left">
                            <img src="https://via.placeholder.com/100x361">
                        </div>
...
<div class="divide50"></div>
 ...
 <!-- 07. 텍스트 예제 -->
<div class="row">
    <div class="col-md-12 ko">

        <strong>비전</strong><br>
        뛰어난 기술과 완벽한 품질로 불황에도 경쟁력을 가진 작지만 강한기업<br><br>
        ...
        1588-1234 로 전화주시면 친절한 설명 드리겠습니다. 감사합니다.
...
<div class="row">
    <div class="col-md-12">
        <div class="table-responsive">
            ...
            <table cellspacing="0" border="1" class="tbl_type table ko" style="width:1140px;">
            <caption>SOFTZONE TABLE</caption>
            <colgroup>
            <col width="140"><col><col width="120"><col>
            </colgroup>
            ...
            <tr>
            <th scope="row">업종</th>
            <td>웹어플리케이션 개발 & 솔루션 개발 & 템플릿 개발</td>
            <th scope="row">지역</th>
            <td>경기도</td>
            </tr>
            <tr>
...
<!--02.client -->
<div class="container">
                <h2 class="line">Client</h2>
                <div class="divide20"></div>
                <div class="row">
                    <div class="col-md-12 no-padding">
                        <div class="owl-carousel owl-theme">
                            <div class="item"><img src="https://via.placeholder.com/218x163"></div>
                            <div class="item"><img src="https://via.placeholder.com/218x163"></div>
                            <div class="item"><img src="https://via.placeholder.com/218x163"></div>
                            <div class="item"><img src="https://via.placeholder.com/218x163"></div>
                            <div class="item"><img src="https://via.placeholder.com/218x163"></div>
       ...
       <div class="container ko">
            ...
            <div class="row">
                <div class="col-md-6 margin20">
					...
					<p><a href="#" class="btn border-black btn-lg">LINK</a></p>
                </div>
                <div class="col-md-6">
					<div class="divide10"></div>
                    <div class="embed-responsive embed-responsive-16by9">
                        <iframe class="embed-responsive-item" src="https://www.youtube.com/embed/Stl9jwWq4T4?autoplay=0&controls=0&loop=1&showinfo=0"></iframe>
                    </div>                    
                </div>
            </div><!--about intro-->
          </div><!-- //row -->
     
        </div><!--.container  end media-->
	...
	<div class="divide20"></div>
		<div class="row">
		   <div class="col-md-6">
                    ...
                    유튜브나 비메오등의 동영상 주소를 적어넣으시면 됩니다. 아이프레임형식 주소안에 넣어주시면 됩니다.
                    </p>
			</div>
		   <div class="col-md-6">
					<div class="embed-responsive embed-responsive-16by9">
...
<div class="container">
			  ...
			  <div class="row">
				...
				<div class="col-sm-6">
				  <div class="row">
					<div class="col-sm-6">
					  <img class="img-responsive mb20" src="https://via.placeholder.com/262x174" alt="Photo">
 ...
 <div class="container ko">
            ...
            <div class="row">
				<div class="col-sm-6 no-padding wow animated fadeInUp" data-wow-delay="0.1s">
			...
			<div class="row">
				<div class="col-lg-6 wow animated fadeInUp" data-wow-delay="0.1s">
				  ...
				  <p>
						...
						랜섬웨어 유포, ② 이메일 등을 통한 기업임원 PC랜섬웨어 유포방식이다.				  
				  </p>
