...
<div style="margin:20px; font-size:12px; font-weignt:700;">
    ...
    <a class="btn btn-sm btn-outline"
        href="https://kornft.org/pages/bon1/certi_history.php?n=<?=$wr_id?>&all=1&op=1&cp=1&rp=1">말소사항 포함</a>
    <a class="btn btn-sm btn-outline"
        href="https://kornft.org/pages/bon1/certi_history.php?n=<?=$wr_id?>&all=0&op=1&cp=1&rp=1">현재 유효사항</a> <br>

    <div class="h6_tl">2.개인정보 포함여부-미리보기 :</div>
    <a class="btn btn-sm btn-outline"
        href="https://kornft.org/pages/bon1/certi_history.php?n=<?=$wr_id?>&all=1&op=1&cp=1&rp=1">포함</a>
    <a class="btn btn-sm btn-outline"
        href="https://kornft.org/pages/bon1/certi_history.php?n=<?=$wr_id?>&all=1&op=0&cp=0&rp=0">미포함</a> <br>
...
?>
                    ...
                    <div class="hls ps32"
                        ...
                        <div class="htb"
                                ...
                                <div class="hcD" style="left:0mm;top:0mm;">
                                    <div class="hcI" style="top:2.01mm;">
                                        <div class="hls ps0"
                                            ...
                                            <div class="hsR"
                                                style="top:0mm;left:0mm;margin-bottom:0mm;margin-right:0mm;width:64.95mm;height:42.96mm;display:inline-block;position:relative;vertical-align:middle;background-repeat:no-repeat;background-image:url('<?= get_file_thumbnail2($wr_id, 0) ;?>');">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="hce" style="left:99.02mm;top:88.04mm;width:32.07mm;height:44.97mm;">
                                <div class="hcD" style="left:0mm;top:0mm;">
                                    <div class="hcI" style="top:26.15mm;">
                                        <div class="hls ps0"
                                            style="line-height:18.82mm;white-space:nowrap;left:0mm;top:0mm;height:18.82mm;width:32.06mm;">
                                            <div class="hsR"
                                                style="top:0mm;left:0mm;margin-bottom:0mm;margin-right:0mm;width:28.45mm;height:18.82mm;display:inline-block;position:relative;vertical-align:middle;background-repeat:no-repeat;background-image:url('<?= get_file_thumbnail2($wr_id, 1) ;?>');">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="hce" style="left:131.08mm;top:88.04mm;width:50.86mm;height:44.97mm;">
                                ...
                                <div class="hsR"
                                    style="top:21.06mm;left:5.24mm;width:38.56mm;height:19.31mm;background-repeat:no-repeat;">
                                    <img width="100%" src="<?= $view['wr_10'];?> "> <br>
                                </div>
                            </div>
    ...
    <!-- #2페이지 -->
        <div class="hpa" style="width:210mm;height:296.99mm;">
            <div class="hsR"
                style="top:1.11mm;left:0.13mm;width:209.87mm;height:295.87mm;background-repeat:no-repeat;background-image:url('NFT 등기부등본 v1.1_말소사항포함_hd7.png');">
            </div>
            <div class="hcD" style="left:13mm;top:10mm;">
                <div class="hcI">
                    <div class="hls ps9"
    ...
    <!-- #3페이지 -->
        <div class="hpa" style="width:210mm;height:296.99mm;">
            <div class="hsR"
                style="top:1.11mm;left:0.13mm;width:209.87mm;height:295.87mm;background-repeat:no-repeat;background-image:url('NFT 등기부등본 v1.1_말소사항포함_hd8.png');">
            </div>
            <div class="hcD" style="left:13mm;top:10mm;">
                <div class="hcI">
                    <div class="hls ps9"
    ...
    <div class="hpa" style="width:210mm;height:296.99mm;">
        <div class="hsR"
            style="top:1.11mm;left:0.13mm;width:209.87mm;height:295.87mm;background-repeat:no-repeat;background-image:url('NFT 등기부등본 v1.1_말소사항포함_hd9.png');">
        </div>
        <div class="hcD" style="left:13mm;top:10mm;">
            <div class="hcI">
                <div class="hls ps9"
                ...
                <div class="hls ps20"
                    ...
                    <div class="htb"
                        ...
                        <div class="hce" style="left:129.26mm;top:56.42mm;width:52.68mm;height:28.49mm;">
                            ...
                            <?php if($view['wr_12']=='검증등기'){ ?>
                            <div class="hsR"
                                style="top:4.02mm;left:3.06mm;width:46.87mm;height:19.31mm;background-repeat:no-repeat;">
        ...
        <div class="htb" style="left:13.50mm;width:169mm;top:188.57mm;height:21.63mm;">
                ...
                <div class="hcD" style="left:1.80mm;top:0.50mm;">
                    <div class="hcI" style="top:1.07mm;">
                        ...
                        <div class="hls ps23"
                            ...
                            <div class="hsR"
                                style="top:0mm;left:0mm;margin-bottom:0mm;margin-right:0mm;width:93.94mm;height:12.84mm;display:inline-block;position:relative;vertical-align:middle;background-repeat:no-repeat;background-image:url('NFT 등기부등본 v1.1_말소사항포함_hdb.png');">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="hce" style="left:131.92mm;top:0mm;width:36.08mm;height:20.64mm;">
                ...
                <div class="hsR"
                    style="top:0.50mm;left:0.12mm;width:19.59mm;height:19.64mm;background-repeat:no-repeat;background-image:url('NFT 등기부등본 v1.1_말소사항포함_hdc.png');">
                </div>
            </div>
        </div>
    </div>
