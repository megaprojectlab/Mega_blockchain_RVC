...
;(function($){
	...
	$.fn.bxSlider = function(options){
		...
		var appendControls = function(){
			slider.controls.next = $('<a class="bx-next" href=""><i class="fa fa-chevron-circle-right"></i><span>' + slider.settings.nextText + '</span></a>');
			slider.controls.prev = $('<a class="bx-prev" href=""><i class="fa fa-chevron-circle-left"></i><span>' + slider.settings.prevText + '</span></a>');
