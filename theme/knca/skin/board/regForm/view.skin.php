				...
				<div class="regFormList">
					...
					<?
						...
						for($k=0;$k<count($formContent);$k++){
							...
							if($formList[1]=='text'){
								echo '<input type="text" placeholder="'.$formList[2].'" name="">';
							}
							...
							if($formList[1]=='checkbox'){
								$formListCont = explode(',',$formList[2]);
								for($h=0;$h<count($formListCont);$h++){
									echo '<label><input type="checkbox" name="" value="'.$formListCont[$h].'"> '.$formListCont[$h].' </label>';
								}
							}
							...
							if($formList[1]=='radio'){
								$formListCont = explode(',',$formList[2]);
								for($h=0;$h<count($formListCont);$h++){
									echo '<label><input type="radio" name="radioNm" value="'.$formListCont[$h].'"> '.$formListCont[$h].' </label>';
								}
							}
							...
							if($formList[1]=='tel'){
								...
								echo '</select>';
								echo '- <input type="text" placeholder="" name="" class="tel">';
								echo '- <input type="text" placeholder="" name="" class="tel">';
							}

							if($formList[1]=='email'){
								echo '<input type="text" placeholder="" name="" class="email"> @ ';
								echo '<input type="text" placeholder="" name="" class="email"> ';
								echo '<select>';
...
<!-- 							</select> -->
<!-- 							- <input type="text" placeholder="" name="" class="tel"> -->
<!-- 							- <input type="text" placeholder="" name="" class="tel"> -->
<!-- 						</li> -->
<!-- 						<li> -->
<!-- 							<span>이메일</span> -->
<!-- 							<input type="text" placeholder="" name="" class="email"> @ -->
<!-- 							<input type="text" placeholder="" name="" class="email"> -->
<!-- 							<select> -->
...
<!-- 						<li> -->
<!-- 							<span>체크박스</span> -->
<!-- 							<label><input type="checkbox" name=""> 옵션1</label> -->
<!-- 							<label><input type="checkbox" name=""> 옵션2</label> -->
<!-- 							<label><input type="checkbox" name=""> 옵션3</label> -->
<!-- 						</li> -->
<!-- 						<li> -->
<!-- 							<span>레디오박스</span> -->
<!-- 							<label><input type="radio" name="radio1"> 옵션1</label> -->
<!-- 							<label><input type="radio" name="radio1"> 옵션2</label> -->
<!-- 							<label><input type="radio" name="radio1"> 옵션3</label> -->
<!-- 						</li> -->
<!-- 						<li> -->
<!-- 							<span>문의사항</span> -->
<!-- 							<textarea></textarea> -->
<!-- 						</li> -->
				...
				<div class="regFormPrivacy">
					<h2>개인정보처리방침 <button class="btn privacyCloseBtn">닫기</button></h2>
					<div class="regFormPrivacyCont"><?=$view['content']?></div>
				</div>
			</div><!--regFormFrame-->

			<div class="regFormCode">
				<pre>
$getFrom="<?=$bo_table?>";
$formNum="<?=$view['wr_id']?>";
