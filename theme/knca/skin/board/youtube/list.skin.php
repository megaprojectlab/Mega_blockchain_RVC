						...
						<?php
                            ...
                            if(isset($thumb['src']) && $thumb['src']) {
								...
								if(isset($youtubeID[2]) && $youtubeID[2] == "youtu.be") {
									$img_content = '<i class="youtube_img"><sup style="background-image:URL(//img.youtube.com/vi/'.$youtubeID[3].'/sddefault.jpg);"" alt="'.$list[$i]['subject'].'"></sup><sub><i class="imgAr"><img src="'.G5_THEME_URL.'/plugin/websiting/imageSpacer.php?w=600&h=338" alt="youtube image spacer"></i></sub></i>
								';
								} else {

									if($board['bo_gallery_height'] == 0){
										$img_content = '<i class="imgAr"><img src="'.G5_THEME_URL.'/plugin/websiting/imageSpacer.php?w=600&h=600" alt="이미지 없음"></i><b>no image</b>';
									} else {
										$img_content = '<i class="imgAr"><img src="'.G5_THEME_URL.'/plugin/websiting/imageSpacer.php?w=600&h=338" alt="이미지 없음"></i><b>no image</b>';
									}
								}
                            }
