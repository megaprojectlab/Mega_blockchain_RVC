...
<article id="bo_v" style="width:<?php echo $width; ?>">
 <div  class="bg-gray1 pt30 pl20 ">
    <header>
        <h2 id="bo_v_title" class="sm-fs10">
            <?php if ($category_name) { ?>
            <span class="bo_v_cate"><?php echo $view['ca_name']; // 분류 출력 끝 ?></span> 
            <?php } ?>
            <span class="bo_v_tit sm-fs-14">
            <?php
    ...
    <section id="bo_v_info" class="border-b3 pl0">
        <h2>페이지 정보</h2>
        <?php /* 
