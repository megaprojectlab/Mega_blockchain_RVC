...
<div id="bo_list" style="width:<?php echo $width; ?>">
    ...
    <div class="likeTbl">
        ...
        <li class="likeTblTr likeTblTh">
            ...
            <div class="mvInlineN"><?php echo subject_sort_link('wr_datetime', $qstr2, 1) ?>날짜  <i class="fa fa-sort" aria-hidden="true"></i></a></div>
        </li>
        <?php
        ...
        <li class="<?php if ($list[$i]['is_notice']) echo "bo_notice"; ?> likeTblTr likeTblTd">
            ...
            <div class="mvInlinev fs-10"><i class="fa fa-clock-o"></i> <?php echo $list[$i]['datetime'] ?></div>
