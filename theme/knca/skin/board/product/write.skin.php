...
<section id="bo_w">
    ...
    <div class="write_div">
        ...
        <input type="text" name="wr_1" value="<?php if(isset($write['wr_1']) && $write['wr_1']) echo $write['wr_1'] ?>" id="wr_1" class="frm_input full_input" size="50" placeholder="제품간략설명(100자이내)">
    </div>

    <div class="write_div">
        <label for="wr_2" class="sound_only">제품간략설명2(100자이내)</label>
        <input type="text" name="wr_2" value="<?php if(isset($write['wr_2']) && $write['wr_2']) echo  $write['wr_2'] ?>" id="wr_2" class="frm_input full_input" size="50" placeholder="제품간략설명2(100자이내)">
    </div>
