...
<article id="bo_v" style="width:<?php echo $width; ?>">
    ...
    <section id="bo_v_info">
        ...
        <?php if($view['wr_email']){ ?><span class="sound_only">이메일</span> <strong><i class="fa fa-envelope-o" aria-hidden="true"></i> <?php echo $view['wr_email'] ?></strong><?php } ?>
        <?php if($view['wr_email']){ ?><span class="sound_only">홈페이지</span> <strong><i class="fa fa-h-square" aria-hidden="true"></i> <?php echo $view['wr_homepage'] ?></strong><?php } ?>
