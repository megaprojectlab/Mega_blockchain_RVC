...
<article id="bo_v" style="width:<?php echo $width; ?>">
    ...
    <section id="1bo_v_info" class="border-b2 bg-gray1 mb30">

        <div class="border-t2 my-10"></div>

        <div class="my-10 ml20">
            
        <span class="btn-12 bg-gray pb20 mr10">언론사(미디어)</span> <span class="mr10"><?php echo $view['wr_10'] ?></span> 
        <span class="btn-12 bg-gray2 ml20">글쓴이</span> <span class="mr20"><?php echo $view['wr_9'] ?></span> 
        <span class="btn-12 bg-gray2 ml20">보도일</span> <span><?php echo $view['wr_8'] ?></span>  
        </div>

        <div class="fs-11 pb10 ml20">
           <i class="fa fa-eye" aria-hidden="true"></i> <?php echo number_format($view['wr_hit']) ?>회
            <span class="if_date"><span class="sound_only">작성일</span><i class="fa fa-clock-o ml10" aria-hidden="true"></i> <?php echo date("y-m-d H:i", strtotime($view['wr_datetime'])) ?></span>
        </div>
...
<section id="bo_added">    
    ...
    <div id="bo_v_top">
        ...
        <ul class="bo_v_bn border-t2 border-b2 fs-14 sm-fs-12">
            <?php if ($prev_href) { ?><li class="btn_prev transOJ"><a href="<?php echo $prev_href ?>"><i class="fa fa-arrow-left" aria-hidden="true"></i> <span class="nb_tit"> 이전글</span> <b><?php echo $prev_wr_subject;?> </b></a> </li><?php } ?>
            <?php if ($next_href) { ?><li class="btn_next transOJ"> <a href="<?php echo $next_href ?>"><i class="fa fa-arrow-right" aria-hidden="true"></i> <span class="nb_tit">다음글 </span> <b><?php echo $next_wr_subject;?> </b></a> </li><?php } ?>
        </ul>
        <?php } ?>
