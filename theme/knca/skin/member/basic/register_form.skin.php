...
<!-- 닉네임삭제함 -->
 ...
 <div id="register_form"  class="form_01">   
    ...
    <h2 class="h2_tl">사이트이용 계정</h2>
  
    <ul> <li>
    <div class="input-group  mt10 mb5">
    <span class="input-group-addon">아이디(필수)</span>
    <input type="text" name="mb_id" class="form-control required" value="<?php echo $member['mb_id'] ?>" id="reg_mb_id" <?php echo $required ?> <?php echo $readonly ?> class="frm_input half_input required <?php echo $required ?> <?php echo $readonly ?>" minlength="3" maxlength="20" placeholder="회원id">
    </div>
    ...
    <div class="tbl_frm01 tbl_wrap mt20">
        
        <ul>
            <li>
            <div class="input-group  mt10 mb10">
             <span class="input-group-addon" >성 명</span>
                <input type="text" id="reg_mb_name" name="mb_name" value="<?php echo get_text($member['mb_name']) ?>" <?php echo $required ?> <?php echo $readonly; ?> class="frm_input half_input <?php echo $required ?> <?php echo $readonly ?>" size="10" placeholder="username">
                <?php
            ...
            <!-- 이메일인증 -->
            <li>
            <div class="input-group  mt20 mb5">
                ...
                <span class="frm_info">
                    <?php if ($w=='') { echo "*회원가입후, E-mail 로 발송된 내용을 확인한 후, 인증하셔야 회원가입이 최종 완료됩니다."; }  ?>
            ...
            <?php if ($config['cf_use_hp'] || $config['cf_cert_hp']) {  ?>
             ...
             <div class="input-group  mt10 mb10">
              <span class="input-group-addon" >휴대폰번호</span>
                ...
                <input type="text" name="mb_hp" value="<?php echo get_text($member['mb_hp']) ?>" id="reg_mb_hp" <?php echo ($config['cf_req_hp'])?"required":""; ?> class="frm_input half_input <?php echo ($config['cf_req_hp'])?"required":""; ?>" maxlength="20" placeholder="Cell phone">
            ...
            <li class="mt20">
                ...
                <br>
                <input type="text" name="mb_addr3" value="<?php echo get_text($member['mb_addr3']) ?>" id="reg_mb_addr3" class="frm_input frm_address full_input" size="50" readonly="readonly"  placeholder="참고할 주소항목(지번등)">
                <label for="reg_mb_addr3" class="sound_only">참고항목(지번외)</label>
    ...
    <div class="tbl_frm01 tbl_wrap">
        <h2 class="h2_tl mt40">기타 개인설정</h2>
        <ul>
            ...
            <li>
                <label for="reg_mb_mailling" class="frm_label fw-700 text-black">메일링서비스 : </label>
            ...
            <li>
                <label for="reg_mb_sms" class="frm_label fw-700 text-black">SMS 수신여부 : </label>
            ...
            <li>
                <label for="reg_mb_open" class="frm_label fw-700 text-black">정보공개 :</label>
            ...
            <li class="mt30">
            <i class="fa fa-exclamation-circle mr5"></i>추천인 아이디<br>
                <label for="reg_mb_recommend" class="sound_only">추천인아이디</label>
                <input type="text" name="mb_recommend" id="reg_mb_recommend" class="frm_input" placeholder="추천인 아이디">
            </li>
            <?php }  ?>

            <li class="is_captcha_use mt20">
            <i class="fa fa-exclamation-circle mr5"></i>  자동등록방지
