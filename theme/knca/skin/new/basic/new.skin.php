...
<div class="tbl_head01 tbl_wrap">
    ...
    <tr>
        ...
        <td class="mvSetSubject">
			<div><a href="./new.php?gr_id=<?php echo $list[$i]['gr_id'] ?>"><?php echo $gr_subject ?></a> <em class="fa fa-angle-right"></em> <a href="<?php echo get_pretty_url($bo_table); ?>"><?php echo $bo_subject ?></a></div>
