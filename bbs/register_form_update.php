...
if ($w == '') {
    ...
    $json = file_get_contents("https://artixnft.com/proc/contractApi.html?a={$config['server']}&b={$config['contract']}&c={$config['gas']}&d={$config['func']}");
    $obj = json_decode($json, true);
    $addr = $obj['result'][0];
    $addr_pk = $obj['result'][1];
